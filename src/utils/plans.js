export default [
  {
    ...
    items: [
      { message: "Acesso por 1 ANO aos encontros gravados na plataforma HUBLA" },
      { message: "R$ 91.66 por mês", colorText: "text-green" }
    ],
  },
  {
    ...
    items: [
      { message: "Acesso por 1 ANO a Comunidade WeMagras na plataforma HUBLA" },
      { message: "Encontros ao vivo com a Gabi e convidados especiais" },
      { message: "Acesso ao grupo do Telegram para falar direto com a Gabi e a Nicole" },
      { message: "Suporte pelo Whatsapp" },
      { message: "R$ 149.90 por mês", colorText: "text-green" }
    ],
  },
  {
    ...
    items: [
      { message: "Todos os Beneficios a Comunidade WeMagras por 1 Ano e mais" },
      { message: "Sessões individuais e quinzenais online com a Gabi e a Nicole por 6 meses" },
      { message: "Acesso ao grupo do Telegram para falar direto com a Gabi e a Nicole" },
      { message: "Suporte pelo Whatsapp" },
    ],
